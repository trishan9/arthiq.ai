...
const Insights = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Action Bar */}
      <div className="flex flex-wrap items-center justify-between gap-4 mx-auto w-full p-6">
      ...
      {/* Empty State */}
      {!insights && !isLoading && (
        <Card className="border-dashed mx-6">
          <CardContent className="p-12 text-center">
            ...
            <p className="text-muted-foreground max-w-md mx-auto mb-6">
              Our AI analyzes your uploaded documents against Nepal's tax
              regulations, VAT requirements, and compliance frameworks to
              provide actionable insights.
            </p>
            <ul className="text-sm text-muted-foreground flex justify-center items-center flex-col space-y-2 max-w-sm mx-auto text-left mb-6">
              <li className="flex items-center gap-2">
                <span className="text-primary">✓</span> Tax & VAT obligation
                tracking
              </li>
              <li className="flex items-center gap-2">
                <span className="text-primary">✓</span> Compliance risk
                identification
              </li>
              <li className="flex items-center gap-2">
                <span className="text-primary">✓</span> Missing document
                detection
              </li>
              <li className="flex items-center gap-2">
                <span className="text-primary">✓</span> Regulatory threshold
                monitoring
              </li>
              <li className="flex items-center gap-2">
                <span className="text-primary">✓</span> Actionable
                recommendations
              </li>
            </ul>
            {hasDocuments ? (
        ...
        <Card>
          <CardContent className="p-12 text-center">
            ...
            <p className="text-muted-foreground">
              Checking against Nepal's tax regulations, VAT requirements, and
          ...
          <Card className="bg-muted/50">
            <CardContent className="p-4">
              <p className="text-xs text-muted-foreground">
                ⚠️ <strong>Disclaimer:</strong> These insights are for decision
                intelligence purposes only, not compliance enforcement. Always
                consult with a qualified tax professional or chartered
                accountant for official tax filing and regulatory compliance in
                Nepal.
              </p>
            </CardContent>
          </Card>
